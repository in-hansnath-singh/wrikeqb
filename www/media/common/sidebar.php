<div class="menu">                
         <div class="logo_wrap"><a class="logo" href="dashboard.php"><img src="img/logo.png" alt="Aquarius -  responsive admin panel" title="Aquarius -  responsive admin panel"/></a></div>
        <div class="breadLine">            
            <div class="arrow"></div>
        ...
        <div class="admin">
            ...
            <ul class="control">                
                ...
                <li><span class="icon-share-alt"></span> <a href="index.php">Logout</a></li>
            </ul>
            <div class="info">
        ...
        <ul class="navigation">            
           ...
           <li>
                <a href="estimate.php">
                    <span class="isw-archive"></span><span class="text">Create Estimate</span>                 
                </a>
            </li>    
			<li>
                <a href="mysetting.php">
                    <span class="isw-settings"></span><span class="text">My Setting</span>                 
                </a>
            </li>    			
           <?php /* <li class="openable">
                <a href="#">
